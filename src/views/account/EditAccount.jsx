...
const EditProfile = (props) => {
  ...
  const onMobileChange = (mob, data) =>
    onFieldChange(mob, "mobile", true, data);
  ...
  const onSubmitUpdate = () => {
    ...
    const allFieldsFilled = Object.keys(field).some(
      (key) => profile[key] !== field[key]
    );
  ...
  return (
    <Boundary>
      <div className="edit-user">
        <h3 className="text-center">Editer profil</h3>
        ...
        <div className="user-profile-details">
          ...
          <input
            ...
            value={field.email}
          />
          <span className="d-block padding-s">Adresse de livraison</span>
          <input
          ...
          />
          {errorField.mobile && (
            <span className="input-message">{errorField.mobile}</span>
          )}
          {/* <span className="d-block padding-s">Téléphone</span>
          <ReactPhoneInput
            defaultCountry={"ph"}
            disabled={isLoading}
          ...
          <div className="edit-user-action">
            ...
            >
              ...
              {isLoading ? "Mise à jour du profil" : "Mettre à jour le profil"}
            </button>
          </div>
        </div>
      </div>
      <Modal isOpen={isOpenModal} onRequestClose={onCloseModal}>
        <div className="text-center padding-l">
          ...
          <p>
            Pour continuer de mettre à jour le profil incluant votre &nbsp;
            <strong>email</strong>,
            <br />
        ...
        <div className="d-flex-center">
          <button className="button" onClick={onConfirmUpdate}>
            Confirmer
          </button>
        </div>
        <button
